...
public class Kawiarnia 
{
	public static void main(String args[]) 
	{
		...
		System.out.println(napoj.getOpis() + " - cena: " + napoj.koszt() + " zł ");
 
		Napoj napoj2 = new MocnoPalona();
		napoj2 = new Czekolada(napoj2);
		napoj2 = new Czekolada(napoj2);
		napoj2 = new BitaSmietana(napoj2);
		System.out.println(napoj2.getOpis() + " - cena: " + napoj2.koszt() + " zł ");
		...
		System.out.println(napoj3.getOpis() + " - cena: " + napoj3.koszt() + " zł ");
	}
}
